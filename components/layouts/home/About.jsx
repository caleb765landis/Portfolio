		...
		<>
			<div className="card shadow-lg shadow-gray-700">
				...
				<p className="text-lg md:text-xl">
					...
					student. I am always learning new concepts and technologies, and I can
					pick up new skills pretty quickly. I've worked on many projects
					individually and in group settings. When collaboriting with others, I
					lead by emphasizing strong teamwork, thoughtful organization, and
